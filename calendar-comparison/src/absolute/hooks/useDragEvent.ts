...
export const useDragEvent = ({
  ...
  }, [dragState, hourHeight, durationMinutes, containerRef, onDayHover]);
  ...
  }, [dragState, event, onUpdate, hourHeight, durationMinutes, onDayHover]);
  ...
  }, [dragState, hourHeight, onDayHover]);
