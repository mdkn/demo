...
│ Header                                    [Reset Button] │
├─────────────────────────────────────────────────────────┤
│ MemoGrid (react-grid-layout container)                  │
│                                                          │
│  ┌──────────┐  ┌──────────┐  ┌──────────┐              │
...
│  └──────────┘  └──────────┘                             │
│                                                          │
│  Double-click empty space to create new memo            │
└─────────────────────────────────────────────────────────┘
```
...
App (src/App.tsx)
│
├─ useMemos hook (src/hooks/useMemos.ts)
...
│
└─ MemoGrid (src/components/MemoGrid/)
   ├─ GridLayout (react-grid-layout)
   │  ├─ Grid configuration (12 cols, 30px row height)
   │  ├─ Layout management (drag, resize, position)
   │  └─ Double-click handler (create new memo)
   │
   └─ MemoCard[] (src/components/MemoCard/)
      ├─ Delete button (×)
      ├─ Color picker button (🎨)
      ├─ Editable content (double-click to edit)
      └─ ColorPicker popup (src/components/ColorPicker/)
         └─ 7 preset colors
```
...
┌──────────────────────────────────────────────────────────┐
│ localStorage                                              │
│  ├─ grid-memos: Memo[] (id, content, color)             │
│  └─ grid-layout: Layout[] (i, x, y, w, h)               │
└────────────────┬─────────────────────────────────────────┘
                 │ ↕ sync
          ┌──────┴──────┐
          │ useMemos    │
